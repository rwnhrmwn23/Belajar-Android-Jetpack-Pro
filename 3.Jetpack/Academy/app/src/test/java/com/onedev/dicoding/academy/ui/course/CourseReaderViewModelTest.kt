...
class CourseReaderViewModelTest {
    ...
    private val dummyModules = DataDummy.generateDummyModules(courseId)[0]
    private val moduleId = dummyModules.moduleId
    ...
    fun getSelectedModule() {
        ...
        assertEquals(content, dummyModules.contentEntity?.content)
    }
}